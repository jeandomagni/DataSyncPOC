...
using OfflineSyncPwaDemoApp.Local.Medications.Api.Services;
...
RecurringJob.AddOrUpdate<IMedicationsService>("syncdata", medicationsService => medicationsService.Refresh(), Cron.Minutely);
